  ...
  <div id="main-content">
    ...
    <div class="content-box">
      ...
      <div class="content-box-header">
        <h3 id="h3news">增加敏感词&nbsp;       
    <%
	String user = (String) request.getAttribute("sensitive");    
	if(user != null){
		if("新增成功".equals(user)){
    %>
    ...
    <% 
   	...
   	%>
   	<a href='<%=basePath2 %>/manager/AdminSensitiveMg'><span style='color:blue;font-size:100%' >返回</span></a>
   	<%
    } 
    %>
    </h3>
      ...
      <div class="content-box-content">
        <div class="tab-content default-tab" id="tab2">
          <form action="<%=basePath2 %>manager/AdminSensitiveAdd" method="post"> 
            <fieldset>
            <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
            <p>
              <label>敏感词</label>
              <input class="text-input small-input" type="text" id="name" name="sensitive" />           
            </p>
            <p>
              <input class="button" type="submit" value="增加" />              
            </p>
            </fieldset>
            <div class="clear"></div>
            <!-- End .clear -->
