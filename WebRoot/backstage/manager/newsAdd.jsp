...
{
    var r=confirm("你的文章将进入待审核状态，确认提交？");
    if (r==true)
    {
      ...
      // var content= $("textarea[name='ARTI_CONTENT']").val(); 
       ...
       $.ajax({
               url:"manager/NewsAddServlet",
               type:"POST",
               data:{art_name:name,art_recommend:recommend,art_author:author,art_keyword:keyword,art_cateid:cateid,art_content:content},
               dataType:"text",
  ...
  <div id="sidebar">
    <div id="sidebar-wrapper">
      ...
      <jsp:param value="blog" name="index" />
			<jsp:param value="newsAdd" name="msg" />
      </jsp:include> 
      ...
      <div class="content-box-content">
        <div class="tab-content default-tab" id="tab2">
          <form id="fsubmit">
            ...
            <p>
              <label>文章标题</label>  
              <input class="text-input small-input" type="text" id="small-input" name="ARTI_NAME" /><span id="note"></span>
		...
		<input type="radio" name="ARTI_RECOMMEND" value=0 /> 否         
              <p>
				<label>作者</label> 
				<input class="text-input medium-input datepicker" type="text" id="medium-input" name="ARTI_AUTHOR" />
				<span id="noteau"></span>
            ...
            <p>
              <label>关键字</label>
              <input class="text-input large-input" type="text" id="large-input" name="ARTI_KEYWORD" />
            </p>
            <!-- <p>
            ...
            <p>
              <label>文章内容  </label>
              <textarea  cols="79" rows="15" class="ckeditor" name="ARTI_CONTENT"></textarea>
            </p>
            <p>
              <input class="button" type="button" value="提交" id="submitbuttonclick" onclick="show_confirm()"/>
              <span id="noteco"></span>
            </p>
            </fieldset>
            <div class="clear"></div>
