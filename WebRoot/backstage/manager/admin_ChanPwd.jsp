...
<div id="body-wrapper">
  ...
  <div id="main-content">
    ...
    <%
	String user = (String) request.getAttribute("admin");    
	if(user != null){
		if("修改成功".equals(user)){
    %>
    ...
    %>
      ...
      <div class="content-box-content">
        <div class="tab-content default-tab" id="tab2">
          <form action="<%=basePath2 %>manager/AdminUserChanPwd" method="post"> 
            <fieldset>
            ...
            <p>
              <label>再次输入新密码</label>
              <input class="text-input small-input" type="password" id="newpwd2" name="newpwd2" />           
            </p>
            <p>
